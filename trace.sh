...
export NANOS6_CONFIG_OVERRIDE="version.debug=true,version.instrument="extrae",cluster.disable_remote=false"
...
export LD_PRELOAD="@LIBASAN@:${EXTRAE_HOME}/lib/libnanosmpitrace.so"
$@
unset LD_PRELOAD
