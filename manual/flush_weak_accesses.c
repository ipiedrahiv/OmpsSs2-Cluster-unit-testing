...
bool test_flush_weak_accesses()
{
	...
	#pragma oss task weakin(buff[0;ARRAY_SZ]) weakinout(sum[0;tasks_nr]) label("sum_decompose")
...
{
	test_t test = FUNC_DEF(test_flush_weak_accesses);
